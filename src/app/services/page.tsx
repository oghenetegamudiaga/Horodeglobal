...
import { supabase, Service, getSiteContentMap, DEFAULT_SITE_CONTENT } from "@/lib/supabase";
...
export default async function ServicesPage() {
  ...
  const introEyebrow = content.services_intro_eyebrow || DEFAULT_SITE_CONTENT.services_intro_eyebrow;
  const introHeading = content.services_intro_heading || DEFAULT_SITE_CONTENT.services_intro_heading;
  const introSubhead = content.services_intro_subhead || DEFAULT_SITE_CONTENT.services_intro_subhead;
  const ctaTitle = content.services_cta_title || DEFAULT_SITE_CONTENT.services_cta_title;
  const ctaText = content.services_cta_text || DEFAULT_SITE_CONTENT.services_cta_text;
